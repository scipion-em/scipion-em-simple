...
from simple.protocols import ProtCluster3D
from pyworkflow.em.protocol import ProtImportVolumes, ProtImportParticles
from pyworkflow.tests import *

class TestCluster3DBase(tests.BaseTest):
...
class TestCluster3D(TestCluster3DBase):
    @classmethod    
    def setUpClass(cls):
        tests.setupTestProject(cls)
    ...
    def test_Ref3D(self):
        prot2 = self.newProtocol(ProtCluster3D, maxIter=1, symmetry="c1")
